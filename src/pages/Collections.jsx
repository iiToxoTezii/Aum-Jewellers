  ...
  return (
    <div className="collections-view">
      <section className="relative overflow-hidden pt-32 pb-20" style={{
        ...
        display: 'flex', 
        alignItems: 'center',
        backgroundImage: "linear-gradient(rgba(23, 26, 19, 0.75), rgba(23, 26, 19, 0.95)), url('/images/Jewellery/bridal_3.png')",
      ...
      {/* Divider stripes before collections grid */}
      <div className="luxury-divider-stripes" style={{ margin: '4rem auto 0' }}>
        <div className="luxury-stripe-line"></div>
        <div className="luxury-stripe-dot"></div>
        <div className="luxury-stripe-line"></div>
      </div>

      <div className="premium-container py-12 pb-32 relative z-10">

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 md:gap-6 lg:gap-8">
        {categories.map((cat, i) => (
          <motion.div 
            ...
            viewport={{ once: true }}
            className={`collections-card ${cat.isComingSoon ? 'opacity-70' : ''}`}
          >
            <div className="card-img-wrap" style={{ position: 'relative', aspectRatio: '4/5', width: '100%', overflow: 'hidden' }}>
              ...
              <div className="card-content" style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '2rem', zIndex: 10 }}>
                <h3 className="text-white text-2xl mb-3">{cat.name}</h3>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="dashboard-card mt-16 text-center"
      >
